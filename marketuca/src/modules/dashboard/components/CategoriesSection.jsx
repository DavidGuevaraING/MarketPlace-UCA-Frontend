    ...
    <div className="container px-4 py-12 mx-auto z-10">
      <div className="flex items-center justify-between mb-8">
        ...
        <motion.div whileHover="hover" whileTap="tap" variants={buttonVariants}>
          <button className="text-[#0056b3] hover:text-[#339CFF] transition-colors">Ver todas</button>
        </motion.div>
      </div>
      <div className="grid grid-cols-3 gap-4 mb-12 sm:grid-cols-4 md:grid-cols-7">
